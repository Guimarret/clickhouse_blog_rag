...
\author{
  \textbf{Guilherme Esteves Marret$^{1}$, João Paulo Martins de Brito$^{1}$, Matheus Castro Alexandre$^{1}$, Leonardo de Lelis Rossi$^{1}$} \\
  \texttt{guimarret@gmail.com, joao.paulomartins107@gmail.com, castro3filho@gmail.com, leoboralelis@gmail.com} \\[0.4em]
