...
\author{
  \textbf{Guilherme Esteves Marret$^{1}$, João Paulo Martins de Brito$^{1}$} \\
  \textbf{Matheus Castro Alexandre$^{1}$, Leonardo de Lelis Rossi$^{1}$} \\[0.3em]
  \texttt{guimarret@gmail.com, joao.paulomartins107@gmail.com} \\
  \texttt{castro3filho@gmail.com, leoboralelis@gmail.com} \\[0.4em]
  $^{1}$ Faculdade de Tecnologia de Jundiaí \\
  Jundiaí-SP
}
